...
if __name__ == '__main__':
    ...
    parser.add_argument('--net', default="mb2-ssd-lite", help="The network architecture, it should be of mb1-ssd, mb1-ssd-lite, mb2-ssd-lite or vgg16-ssd.")
    parser.add_argument("--model", type=str, default = "models/ai-pills-camera/",help="Path to the trained PyTorch checkpoint")
    parser.add_argument("--dataset_type", default="voc", type=str, help="Specify dataset type. Currently support voc and open_images.")
    parser.add_argument("--dataset", default = "data/ai-pills-camera", type=str, help="The root directory of the VOC dataset or Open Images dataset.")
    parser.add_argument("--label_file", type=str, default = "data/ai-pills-camera/labels.txt",help="The label file path.")
